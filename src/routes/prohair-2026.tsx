...
export const Route = createFileRoute('/prohair-2026')({
  head: () =>
    pageMeta(
      ...
      'II Международный конгресс PROHAIR 2026: 4–5 сентября 2026, Mövenpick Hotel, Самарканд. Полная научная программа, 24+ международных спикеров, материалы конгресса.',
    ),
  component: Page,
});
